      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 relative">
            ...
            <span className="transform inline-block rotate-1 ml-2">
              Gallery
            </span>
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto relative">
            Capturing moments and stories through the lens. A curated selection
            ...
            >
              <div className="aspect-[4/3] bg-muted relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-6xl text-muted-foreground/30 transform -rotate-12">
                    📷
                  </div>
                </div>
              ...
              <div className="p-6 relative">
                ...
                <p className="text-muted-foreground mb-4 transform translate-x-1">
                  A beautiful capture showcasing{" "}
                  {i === 1
                    ? "portrait"
                    : i === 2
                    ? "landscape"
                    ...
                    ? "street"
                    : "nature"}{" "}
                  photography with dramatic lighting and composition.
                </p>
