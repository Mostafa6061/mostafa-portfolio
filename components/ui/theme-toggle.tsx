...
export const ThemeToggle: FC<ThemeToggleProps> = ({ className }) => {
  ...
  if (!mounted) {
    return (
      <div
        className={clsx(
          "w-[76px] h-[37px] rounded-full bg-muted animate-pulse",
          className
        )}
      />
    );
  ...
  return (
    ...
    >
      <Switch
        ...
        className={clsx(
          "relative focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 flex w-[76px] cursor-pointer items-center rounded-full bg-secondary px-[6px] py-[5px] transition-colors duration-200 dark:bg-secondary",
          className
        )}
      >
        ...
        <span
          className={clsx(
            "inline-block h-7 w-7 transform rounded-full bg-primary transition-transform duration-200 ease-in-out",
        ...
        <LightIcon
          className={clsx(
            "absolute left-[11px] top-[10px] inline-block h-[18px] w-[18px] transition-opacity duration-200",
        ...
        <DarkIcon
          className={clsx(
            "absolute right-[11px] top-[10px] inline-block h-[18px] w-[18px] transition-opacity duration-200",
...
const LightIcon: FC<IconProps> = ({ className }) => {
  return (
    <svg
      viewBox="0 0 18 18"
      fill="none"
...
const DarkIcon: FC<IconProps> = ({ className }) => {
  return (
    <svg
      viewBox="0 0 18 18"
      fill="none"
